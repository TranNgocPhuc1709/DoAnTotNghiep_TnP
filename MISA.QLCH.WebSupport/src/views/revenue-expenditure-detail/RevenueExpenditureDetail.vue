<template src="./RevenueExpenditureDetail.html"></template>
<style lang="scss" scoped src="./RevenueExpenditureDetail.scss"></style>
<script lang="ts">
import RevenueExpenditureDetail from './RevenueExpenditureDetail';
...
export default{
  ...
  setup() {
    const thisData: Ref<RevenueExpenditureDetail> = ref(new RevenueExpenditureDetail());
    return { thisData };
  },
