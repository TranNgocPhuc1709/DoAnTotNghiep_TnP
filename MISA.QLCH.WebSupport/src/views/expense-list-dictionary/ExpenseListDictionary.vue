<template src="./ExpenseListDictionary.html"></template>
<style lang="scss" scoped src="./ExpenseListDictionary.scss"></style>
<script lang="ts">
import ExpenseListDictionary from './ExpenseListDictionary';
...
export default {
  ...
  setup() {
    const thisData: Ref<ExpenseListDictionary> = ref(new ExpenseListDictionary());
    return { thisData };
  },
  methods: {
    ...
    async createComponent() {
      ...
      const frmDetail = (await import(`../expense-detail/ExpenseDetail.vue`)).default;
      return frmDetail;
    },
  }
