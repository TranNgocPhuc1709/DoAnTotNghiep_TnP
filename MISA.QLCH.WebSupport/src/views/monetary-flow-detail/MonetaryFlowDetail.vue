<template src="./MonetaryFlowDetail.html"></template>
<style lang="scss" scoped src="./MonetaryFlowDetail.scss"></style>
<script lang="ts">
import MonetaryFlowDetail from './MonetaryFlowDetail';
...
export default{
  ...
  setup() {
    const thisData: Ref<MonetaryFlowDetail> = ref(new MonetaryFlowDetail());
    return { thisData };
  },
